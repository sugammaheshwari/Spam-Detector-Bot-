import praw
import re
from credentials import client_id, client_secret, password, user_agent, username
import random
import time
...
if __name__ == "__main__":
    ...
    while True:
        current_search_query = random.choice(["udemy"])                     # our targert spammer on reddit
        spam_content = []
        trashy_users = {}
